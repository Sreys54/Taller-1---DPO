...
public class CalculadoraEstadisticas
{
	...
	public String darPaisdeAtleta (String nombreAtleta)
	{
		Atleta rta = buscarAtleta(nombreAtleta);
		if (rta != null)
		{
			Pais respuesta = rta.darPais();
			return respuesta.darNombre();
		}
		return "No se encontro el país de ese atleta";
	}
}
