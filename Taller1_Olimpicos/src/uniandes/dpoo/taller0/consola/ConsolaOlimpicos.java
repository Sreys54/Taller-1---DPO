...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país que un cierto atleta representa.");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	//Modificaciones Taller 1 
	private void ejecutardarPaisdeAtleta()
	{
		System.out.println("\n" +"Pais del cual un Atleta pertenece" +"\n");
		String nombre = input("Por favor ingrese el nombre del atleta del cual desea saber su país");
		String rta = calculadora.darPaisdeAtleta(nombre);
		System.out.println("El país el cual " + nombre + " representa es " + rta + ".");
	}
	/**
